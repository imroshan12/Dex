...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.sarveshroshan.dex")!.appending(path: "Dex.sqlite")
        }
